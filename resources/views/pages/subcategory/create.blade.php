...
@section('page-title')
   Create Subcategory for {{$cat->Name}}
@endsection
        ...
        <div class="panel-body">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        {!! Form::select('type', ['Folder' => 'Folder', 'Article' => 'Article'], null, ['id' => 'type-option', 'class' => 'form-control', 'placeholder' => '--Select Subcategory Type--' ,'required']) !!} 
                    </div>
                </div>
