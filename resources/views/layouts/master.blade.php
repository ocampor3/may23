...
<script type="text/javascript" src="{{ URL::asset('/js/main.wrapper.js') }}"></script>  
</head>
        ...
        <ul class="treeview-menu">
          ...
          <li><a href="{{ route('site.show', $site->SiteCode) }}" id="{{$site->Id}}" class="subclass"><i class="fa fa-plus-circle"></i>{{ $site->Title }}</a>
            ...
            <ul class="treeview-menu">
              ...
              <li><a  href="{{ route('securitygroup.show',$site->Id) }}"><i class="fa fa-lock"></i> Security Group</a></li>
              @endif
