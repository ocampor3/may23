    ...
    <div class="error-container">
        <div class="error-page">
            ...
            <div class="error-content">
                <h3><i class="fa fa-warning text-yellow"></i> Oops! Access Denied. You are not authorized to access this page.</h3>

                <p>                    
                    Meanwhile, you may <a href="<?php echo e(url('/')); ?>">return to main page</a>.
                </p>
            </div>
        </div>
    </section>
