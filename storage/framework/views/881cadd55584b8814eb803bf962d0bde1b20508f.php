...
<?php echo Form::open([      
    ...
    <div class="panel panel-primary">       
        <div class="panel-body">
            <div class="form-horizontal">
                ...
                <div class="form-group <?php echo e($errors->has('name') ? ' has-error' : ''); ?>">   
                    ...
                    <div class="col-sm-3">
                        <input class="form-control" name="name" type="text" maxlength="160" value="<?php echo e(old('name')); ?>" required />
                ...
                <div class="form-group <?php echo e($errors->has('username') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-sm-3">
                        <input class="form-control" type="text" name="username" maxlength="160" value="<?php echo e(old('username')); ?>" required />
                ...
                <div class="form-group">
                    ...
                    <!-- <?php if(Auth::user()->UserGroup == 'Admin'): ?>
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <?php echo Form::select('sitecode', $site, null, ['id' => 'type-option', 'class' => 'form-control', 'placeholder' => '--Select Type--' ,'required']); ?> 
                            </div>
                        </div>
                        <?php endif; ?> -->
                        <?php endif; ?>

                        <?php if(Auth::user()->UserGroup == 'Admin' || Auth::user()->UserGroup == 'Owner'): ?>
                        <!-- <div class="form-group">
                            <label class="col-sm-2 control-label">Security Group: </label>
                            <div class="col-sm-3">
                                <?php echo Form::select('securitygroup', $securitygroups, null, ['id' => 'type-option', 'class' => 'form-control', 'placeholder' => '--Select Type--' ,'required']); ?> 
                            </div>
                        </div> -->
                        <?php endif; ?>
                        ...
                        <div class="form-group" style="display:none;">   
                            <div class="col-sm-10"> 
                                <div id="propDD">
                                    ...
                                    <?php if(Auth::user()->UserGroup == 'Admin'): ?>
                                    <div class="col-sm-3">                              
                                        <?php echo Form::select('sitecodeTemp', $site, null, ['id' => '', 'class' => 'form-control sitedropdown', 'placeholder' => '--Select Site--']); ?>
                                    ...
                                    <div class="col-sm-3">                              
                                        <?php echo Form::select('sitecodeTemp', Auth::user()->handledSites->pluck('Title', 'Id'), null, ['id' => '', 'class' => 'form-control sitedropdown', 'placeholder' => '--Select Site--']); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <a href="<?php echo e(route('user.index')); ?>" class="btn btn-danger">Cancel</a>
                        </div>
                    </div>
        ...
        <script type="text/javascript">
         ...
         var $ddTemp = $("#propDD");              
         var propHash = 1;
         var ug =  <?php echo "'".Auth::user()->UserGroup."'"; ?>
