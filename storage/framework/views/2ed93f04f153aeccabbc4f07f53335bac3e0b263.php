...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo e(URL::asset('/AdminLTE-2.3.7//plugins/iCheck/square/blue.css')); ?>">
    <!-- MY STYLE CSS -->
...
<!-- iCheck -->
<script src="<?php echo e(URL::asset('/AdminLTE-2.3.7/plugins/iCheck/icheck.min.js')); ?>"></script>
