        ...
        <div class="panel-body">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <?php echo Form::select('type', ['Folder' => 'Folder', 'Article' => 'Article'], null, ['id' => 'type-option', 'class' => 'form-control', 'placeholder' => '--Select Category Type--' ,'required']); ?> 
                    </div>
                </div>
