...
<?php $__env->startSection('page-title'); ?>
   Edit Article: <?php echo e($article->Title); ?>
                ...
                <div class="form-group"> <!-- FORM group first  -->
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="form-group <?php echo e($errors->has('title') ? ' has-error' : ''); ?>">              
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="title" class="form-control" maxlength="160" value="<?php echo e($article->Title); ?>" required />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <?php echo Form::select('categoryId', $category, $article->CategoryId, ['class' => 'form-control', 'placeholder' => '--Select Category--', 'required']); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <?php echo Form::select('status', ['Live' => 'Live', 'Test' => 'Test', 'New' => 'New', 'TurnOff' => 'Turn Off'], $article->Status, ['class' => 'form-control', 'placeholder' => '--Select Status--' ,'required']); ?> 
                            </div>
                        </div>
                        ...
                        <div class="form-group <?php echo e($errors->has('order') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-sm-2">
                                <input class="form-control" name="order" placeholder="0" min="1" type="number" value="<?php echo e($article->SortOrder); ?>" required>
                        ...
                        <div id="Text" class="article-hide">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-display">
                                    ...
                                    <span id="imgActive2" class="filename_upload has_filename"><?php echo e($article->FileName); ?></span>
                        ...
                        <div id="File" class="article-hide">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">File Name: </label>
                                <div class="col-display">
                                    <span id="imgActive3" class="filename_upload has_filename"><?php echo e($article->FileName); ?></span>
                        ...
                        <div id="DIRECTTEXT" class="article-hide">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Value: </label>
                                <div class="col-sm-10">
                                    <?php if($article->Type == 'DIRECTTEXT' || $article->Type == 'DIRECTTEXTFULL'): ?>
                                        <textarea id="wysiwyg" class="form-control selDirText" name="value[DIRECTTEXT]" row="5" style="font-size: 14px; line-height: 18px; border: 1px solid rgb(221, 221, 221); padding: 10px; resize: none;" placeholder="Enter text..."> <?php echo e($article->Value); ?></textarea>
                                    <?php else: ?>
                        ...
                        <div id="LINK" class="article-hide">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <?php if($article->Type == 'LINK'): ?>                                    
                                        <input id="filelinkLINK" type="text" class="form-control selLinkNorm" name="value[LINK]" value="<?php echo e($article->Value); ?>">
                                    <?php else: ?>
                        ...
                        <div id="LINKExternal" class="article-hide">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <?php if($article->Type == 'LINKExternal'): ?>
                                        <input id="filelinkLINKExternal" type="text" class="form-control selLinkExt" name="value[LINKExternal]" value="<?php echo e($article->Value); ?>">
                                    <?php else: ?>
                        ...
                        <div id="LINKLogin" class="article-hide">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <?php if($article->Type == 'LINKLogin'): ?>
                                        <input id="filelinkLINKLogin" type="text" class="form-control selLinkLog" name="value[LINKLogin]" value="<?php echo e($article->Value); ?>">
                                    <?php else: ?>
                        ...
                        <div id="LINKInheritLogin" class="article-hide">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">                                   
                                    ...
                                    <?php if($article->Type == 'LINKInheritLogin'): ?>
                                        <input id="filelinkLINKInheritLogin" type="text" class="form-control selLINKInherit" name="value[LINKInheritLogin]" value="<?php echo e($article->Value); ?>">
                                    <?php else: ?>
                        ...
                        <div id="LINKAutofill" class="article-hide">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Link: </label>
                                <div class="col-sm-2">
                                    <?php echo Form::select('protocolLINKAutofill', ['http://' => "http://", 'https://' => "https://"], null, ['id' => 'protocolLINKAutofill','class' => 'form-control selLinkAuto', 'placeholder' => '--Select Type--']); ?> 
                                </div>
                        ...
                        <div id="LINKCredential" class="article-hide">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Link: </label>
                                <div class="col-sm-2">
                                    <?php echo Form::select('protocolLINKCredential', ['http://' => "http://", 'https://' => "https://"], null, ['id' => 'protocolLINKCredential','class' => 'form-control selLinkCred', 'placeholder' => '--Select Type--']); ?> 
                                </div>
                        ...
                        <div id="LINKPassword" class="article-hide">
                            <div class="form-group">
                                ...
                                <div class="col-sm-2" style="padding-right: 0px;">
                                    <?php echo Form::select('protocolLINKPassword', ['http://' => "http://", 'https://' => "https://"], null, ['id' => 'protocolLINKPassword','class' => 'form-control selLinkPassword', 'placeholder' => '--Select Type--']); ?> 
                                </div>
                        ...
                        <div id="GeoLocation" class="article-hide">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <?php if($article->Type == 'GeoLocation'): ?>
                                        <input id="geolocation" type="text" class="form-control selGeoLoc" name="value[GeoLocation]" placeholder="Latitude, Longitude (i.e. 44.968046, -94.420307)" value="<?php echo e($article->Value); ?>"/>
                                    <?php else: ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <?php echo Form::select('geoLocAssignedUserId', $users, $article->geoLocAssignedUser == null ? null: $article->geoLocAssignedUser->Id, ['class' => 'form-control selGeoLoc', 'placeholder' => '--Select User--']); ?>
                        ...
                        <div id="CalendarEvent" class="article-hide">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input id="caldescription" type="text" class="form-control selCalEvent" name="caldescription" value="<?php echo e($article->CalendarValue != null ? $article->CalendarValue->Description: ''); ?>"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input id="caldatestart" type="datetime-local" class="form-control selCalEvent" name="caldatestart" value="<?php echo e($article->CalendarValue != null ? $article->CalendarValue->DateStartInput: ''); ?>"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input id="caldateend" type="datetime-local" class="form-control selCalEvent" name="caldateend" value="<?php echo e($article->CalendarValue != null ? $article->CalendarValue->DateEndInput: ''); ?>"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input id="caltzstart" type="text" class="form-control selCalEvent" name="caltzstart" placeholder="UTC" value="<?php echo e($article->CalendarValue != null ? $article->CalendarValue->TimezoneStart: ''); ?>"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input id="caltzend" type="text" class="form-control selCalEvent" name="caltzend" placeholder="UTC" value="<?php echo e($article->CalendarValue != null ? $article->CalendarValue->TimezoneEnd: ''); ?>"/>
                        ...
                        <div id="LinkedArticle" class="article-hide">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <?php echo Form::select('linkedArticleId', $allArticles, $article->Type == 'LinkedArticle' ? $linkedArticle->Id: null, ['id' => 'type-option', 'class' => 'form-control selLinkedArticle', 'placeholder' => '--Select Article--']); ?>
                ...
                <div class="form-group">
                    <div class="col-sm-3">
                        <div class="icon-edit">
                                ...
                                <a href="<?php echo e(route('article.show',Session::get('SiteId'))); ?>" class="btn btn-danger">Cancel</a>
                        </div>
                    </div>
                </div>
    ...
    <?php echo Form::close(); ?>
     ...
     <script type="text/javascript">
        ...
        $( document ).ready(function() 
        {
            ...
            {   
                var url =  "<?php echo e($article->LinkValue); ?>";      
