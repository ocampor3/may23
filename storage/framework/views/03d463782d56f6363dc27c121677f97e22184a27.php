                ...
                <div class="form-group"> <!-- FORM group first  --> 
                    <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <?php echo Form::select('categoryId', $category, null, ['class' => 'form-control', 'placeholder' => '--Select Category--', 'required']); ?>
                     ...
                     <div id="GeoLocation" class="article-hide">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <?php echo Form::select('geoLocAssignedUserId', $users, null, ['class' => 'form-control selGeoLoc', 'placeholder' => '--Select User--']); ?>
                    ...
                    <div id="LinkedArticle" class="article-hide">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <?php echo Form::select('linkedArticleId', $allArticles, null, ['id' => 'type-option', 'class' => 'form-control selLinkedArticle', 'placeholder' => '--Select Article--']); ?> 
